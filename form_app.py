            ...
            for i, p in enumerate(paragraphs):
                ...
                for prefix, val, bold_val, color_val, clear_next in replacements:
                    if prefix in p_text:
                        ...
                        if font_name: prefix_run.font.name = font_name
                        if font_size: prefix_run.font.size = font_size
                        prefix_run.bold = True
                        
                        val_run = p.add_run(str(val))
                        if style: val_run.style = style
                        if font_name: val_run.font.name = font_name
                        if font_size: val_run.font.size = font_size
                        val_run.bold = bold_val
                        if color_val:
                            val_run.font.color.rgb = color_val
                        elif font_color:
                            val_run.font.color.rgb = font_color
